...
<head>
	...
	<title>Sistem Informasi Pengajuan Cuti Online PT. Gabe Indonesia - <?php echo $pagedesc ?></title>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
				...
				<a class="navbar-brand hidden-xs" href="index.php">
					...
					<div class="float-right">&nbsp;<strong>PT. Gabe Indonesia</strong></div>
                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        <li class="sidebar-search">
							<h4>Sistem Informasi Pengajuan Cuti Online <br> <b>PT. Gabe Indonesia</b></h4>
